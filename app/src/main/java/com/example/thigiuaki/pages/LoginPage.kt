...
fun LoginPage(
    ...
    Column(
        ...
        Text(text = " Login " , fontSize = 32.sp , color = Color(0xFFFFC107))
        ...
        Button(
            ...
            Text(text = "Login", fontSize = 20.sp, modifier = Modifier.padding(8.dp))
        }
        ...
        Row(
           modifier = Modifier.fillMaxWidth(),
            ...
            Text(text="Don't have account, " , fontSize = 16.sp, color = Color.White)
            Text(
                text = "Signup",
                fontSize = 16.sp,
